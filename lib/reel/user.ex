defmodule Reel.User do
  ...
  def changeset(%User{} = user, attrs) do
    user
    |> cast(attrs, [:username, :first_name, :last_name, :email, :facebook_id, :facebook_picture, :is_private, :auth_provider])
    |> validate_required([:username, :first_name, :last_name, :email, :facebook_id, :facebook_picture, :is_private, :auth_provider])
